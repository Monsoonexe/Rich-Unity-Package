...
namespace RichPackage.Databases
{
    ...
    public abstract class ADatabaseAsset<TData> : ApexScriptableObject
		where TData : ApexScriptableObject, IDatabaseMember
    {
		[Title("Database")]
		...
		/// <summary>
		/// Very slow add new item that can only be called in the editor.
		/// </summary>
		/// <param name="data">The new item to add.</param>
		public void Editor_AddItem(TData data)
		{
			Collection_Extensions.Add(ref items, data);
