...
namespace RichPackage.SaveSystem
{
    ...
    /// </summary>
    public sealed class EasySave3SaveSystem : ASaveableMonoBehaviour<SaveSystem.SaveSystemData>, ISaveSystem
    {
#region Constants

		protected const string HAS_SAVE_DATA_KEY = "HasData";
        protected const string DEFAULT_SAVE_FILE_NAME = "Save.es3";
...
#region ISaveable Consumers
        ...
        public static void OpenSaveFileInVSCode()
        {
            ...
            var process = System.Diagnostics.Process.Start(ins.SaveFile.settings.FullPath);
        }
