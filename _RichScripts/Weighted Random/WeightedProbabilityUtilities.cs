...
namespace RichPackage.WeightedProbabilities
{
    ...
    public static class WeightedProbabilityUtilities
    {
        ...
        /// </summary>
        public static int GetWeightedIndex<T>(this IList<T> items)
        ...
        public static int GetWeightedIndex<T>(this IList<T> items, int randomValue)
            where T : AWeightedProbability
        {
            int index = 0;
        ...
        /// Get a random element using Weighted algorithm.
        /// </summary>
        public static T GetWeightedRandomElement<T>(this IList<AWeightedProbability<T>> items)
        {
        ...
        /// Get a random element using Weighted algorithm.
        /// </summary>
        public static T GetWeightedRandomElement<T, U>(this IList<U> items)
        ...
        /// </summary>
        public static int GetTotalWeight<T>(this IList<T> probabilityTemplates)
            where T : AWeightedProbability
        {
